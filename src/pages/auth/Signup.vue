<template>
  <VaForm ref="form" @submit.prevent="submit">
    <h1 class="font-semibold text-4xl mb-4">Registrarse</h1>
    ...
    <VaValue v-slot="isPasswordVisible" :default-value="false">
      <VaInput
        ...
        class="mb-4"
        label="Contraseña"
        messages="La contraseña debe tener al menos 8 caracteres, una letra, un número y un carácter especial"
    ...
    <div class="flex justify-center mt-4">
      <VaButton class="w-full" @click="submit"> Registrarse</VaButton>
    </div>
  </VaForm>
</template>
