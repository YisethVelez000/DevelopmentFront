<template>
  ...
  >
    <h1 class="va-h5 mb-4">Cambiar Nombre</h1>
    <VaForm ref="form" @submit.prevent="submit">
      ...
      <div class="flex flex-col-reverse md:flex-row md:items-center md:justify-end md:space-x-4">
        <VaButton :style="buttonStyles" preset="secondary" color="secondary" @click="emits('cancel')"> Cancelar</VaButton>
        <VaButton :style="buttonStyles" class="mb-4 md:mb-0" type="submit" @click="submit"> Guardar Cambios</VaButton>
      </div>
    </VaForm>
  </VaModal>
</template>
